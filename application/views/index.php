            ...
            <div class="col-lg-6 col-md-6 ">
                <div class="section-search-box d-flex align-items-center aos" data-aos="fade-up">
                    <div class="section-search">
                        <h3>Largest marketplace for your <span>SKILL</span>
...
<section class="how-work truely-one-work" style="padding-top:8%;">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="howworksec">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="howwork aos" data-aos="fade-up">
                                <div class=" d-flex justify-content-center">
                                    <div class="list-out d-flex align-items-center"><span class="list-number">2</span>
                                    </div>
                                    <div class="iconround">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="howwork aos" data-aos="fade-up">
                                <div class=" d-flex justify-content-center">
                                    <div class="list-out d-flex align-items-center"><span class="list-number">3</span>
                                    </div>
                                    <div class="iconround">
