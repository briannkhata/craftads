...
<head>
    <meta charset="utf-8" />
    <title><?=$this->db->get('settings')->row()->app;?> :: <?=$page_title;?></title>
    ...
    <link rel="stylesheet" type="text/css"
        href="<?=base_url();?>assets/global/plugins/bootstrap-summernote/summernote.css">
    ...
    <link href="<?=base_url();?>assets/admin/layout/css/themes/light2.css" rel="stylesheet" type="text/css"
        id="style_color" />
...
<body class="page-quick-sidebar-over-content page-style-square page-header-fixed page-sidebar-fixed page-footer-fixed">
    ...
    <div class="page-header -i navbar navbar-fixed-top">
        ...
        <div class="page-header-inner">
            ...
            <div class="page-logo">
                <a href="">
                    <!--img src="<?=base_url();?>uploads/logo.png" alt="logo" class="logo-default"/-->
